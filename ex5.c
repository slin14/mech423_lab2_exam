...
int main(void)
{
    ...
    /////////////////////////////////////////////////
	// Timer B - 1 MHz, UP mode
	TB1CCR0 = 2000;          // value to count up to in UP mode
  ...
  //setup_timerB_UP_mode(~TIMERB_LED_PORT); // TB1.1 and TB1.2 on P1.6 and P1.7
    ...
    // generate PWM with 50% duty cycle on TB1.1
    TB1CCTL1 |= OUTMOD_7;    // OUTMOD 7 = reset/set (reset at CCRx, set at CCR0)
    TB1CCR1 = 1000;

    // generate PWM with 25% duty cycle on TB1.2
